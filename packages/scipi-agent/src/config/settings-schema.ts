...
export const SETTINGS_SCHEMA = {
	...
	"systemd.enabled": {
		...
		ui: {
			tab: "tools",
			group: "Available Tools",
			label: "Systemd User Services",
			description:
				"Enable the systemd tool for submitting and managing persistent systemd --user services",
		},
	},
	...
	"tools.discoveryMode": {
		...
		ui: {
			...
			group: "Discovery & MCP",
				...
				description:
					"Hide tools behind a search tool to save tokens. 'all' hides non-essential built-ins and MCP tools by default; 'mcp-only' always hides MCP tools; 'auto' hides MCP tools once the tool set has more than 40 tools.",
			},
		},
	...
	"tools.essentialOverride": {
		...
		ui: {
			tab: "tools",
				...
				description:
					"Override the always-loaded built-in tools (default: read, bash, edit, write, find, eval, task, web_search). Leave empty to use defaults.",
			},
		},
