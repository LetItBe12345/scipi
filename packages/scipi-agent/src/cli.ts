...
const TINY_WORKER_ARG = "__scipi_worker_tiny_inference";
const STATS_SYNC_WORKER_ARG = "__scipi_worker_stats_sync";
const TAB_WORKER_ARG = "__scipi_worker_tab";
const JS_EVAL_WORKER_ARG = "__scipi_worker_js_eval";
const STT_WORKER_ARG = "__scipi_worker_stt";
const TTS_WORKER_ARG = "__scipi_worker_tts";
const MNEMOPI_EMBED_WORKER_ARG = "__scipi_worker_mnemopi_embed";
...
export async function runCli(argv: string[]): Promise<void> {
	...
	if (resolvedArgv[0]?.startsWith("__scipi_worker_")) {
